...
public class PendulumRunner {
	...
	GravityConstant c=new GravityConstant(AbstractPendulum.GRAVITY);
	RegularPendulum rp = new RegularPendulum (sLen, pMass, theta0, delta,c);
	SimplePendulum sp = new SimplePendulum (sLen, pMass, theta0,c);
	RegularPendulum rpCoarse = 
	    new RegularPendulum (sLen, pMass, theta0, .1,c);
